...
public class CombatRangedAmmo {
	...
	public enum RangedWeaponData {
		...
		SARADOMIN_BOW(new int[] {19143}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.SARADOMIN_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		
		GUTHIX_BOW(new int[] {19146}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.GUTHIX_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		
		ZAMORAK_BOW(new int[] {19149}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.ZAMORAK_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		
		ZILYANAS_BOW(new int[] {3960}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.SARADOMIN_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),

		LAVA_PERNIX_BOW(new int[] {20115}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.SARADOMIN_ARROW, AmmunitionData.BROAD_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.SHORTBOW),
		
		TOXIC_BLOWPIPE(new int[] {12926}, new AmmunitionData[] {AmmunitionData.BLOWPIPE}, RangedWeaponType.BLOWPIPE),
		
		DRAGONRAGE_BLOWPIPE(new int[] {3962}, new AmmunitionData[] {AmmunitionData.DRAGONRAGE_BLOWPIPE}, RangedWeaponType.BLOWPIPE),
		
		MAGMA_BLOWPIPE(new int[] {12927}, new AmmunitionData[] {AmmunitionData.BLOWPIPE}, RangedWeaponType.BLOWPIPE),
		
		MINIGUN(new int[] {896}, new AmmunitionData[] {AmmunitionData.MINIGUNAMMUNITION}, RangedWeaponType.MINIGUN),
		
		AK47(new int[] {19938}, new AmmunitionData[] {AmmunitionData.BULLETS}, RangedWeaponType.SHORTBOW),
		FLAMETHROWER(new int[] {19939}, new AmmunitionData[] {AmmunitionData.FUEL}, RangedWeaponType.SHORTBOW),
		...
		DARK_LORDS_BOW(new int[] {3961}, new AmmunitionData[] {AmmunitionData.BRONZE_ARROW, AmmunitionData.IRON_ARROW, AmmunitionData.STEEL_ARROW, AmmunitionData.MITHRIL_ARROW, AmmunitionData.ADAMANT_ARROW, AmmunitionData.RUNE_ARROW, AmmunitionData.DRAGON_ARROW}, RangedWeaponType.DARK_BOW),
		...
		ARMADYLIAN_MACHINE(new int[] {19467}, new AmmunitionData[] {AmmunitionData.BRONZE_BOLT, AmmunitionData.OPAL_BOLT, AmmunitionData.IRON_BOLT, AmmunitionData.JADE_BOLT, AmmunitionData.STEEL_BOLT, AmmunitionData.PEARL_BOLT, AmmunitionData.MITHRIL_BOLT, AmmunitionData.TOPAZ_BOLT, AmmunitionData.ADAMANT_BOLT,
	...
	public enum AmmunitionData {
		...
		DRAGONRAGE_BLOWPIPE(new int[] {3962}, -1, 1123, 10, 20, 85, 23, 25),
		MINIGUNAMMUNITION(new int[] {896}, -1, -1, 10, 20, 42, 23, 25),
		...
		SARADOMIN_ARROW(new int[] {19152}, 472, 473, 3, 44, 66, 43, 31),
		GUTHIX_ARROW(new int[] {19157}, 95, 2340, 3, 44, 67, 43, 31),
		ZAMORAK_ARROW(new int[] {19162}, 97, 100, 3, 44, 66, 43, 31),
		
		ARMADYLIAN_ARROW(new int[] {9706}, -1, 374, 3, 44, 103, 43, 31),
		...
		BULLETS(new int[] {19906}, -1, 450, 8, 4, 135, 43, 31),
		...
		FUEL(new int[] {569}, -1, 448, 2, 4, 135, 31, 31);
